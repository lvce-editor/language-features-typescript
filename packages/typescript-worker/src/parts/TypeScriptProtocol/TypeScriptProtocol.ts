...
export type CompletionEntry = ts.CompletionEntry
export type CompletionInfoResponse = ts.WithMetadata<ts.CompletionInfo>
...
export type ImplementationResponse = ts.server.protocol.ImplementationResponse
